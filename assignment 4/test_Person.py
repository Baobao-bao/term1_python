...
class Test_Person(unittest.TestCase):
    ...
    def test_to_dict(self):
        self.assertTrue(self.person1.to_dict()["id"] == 1)
        self.assertTrue(self.person1.to_dict()["fname"] == "Mike")
        self.assertTrue(self.person1.to_dict()["lname"] == "Liao")
        self.assertTrue(self.person1.to_dict()["age"] == 80)
